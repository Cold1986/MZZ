...
namespace MZZ.BLL
{
	...
	{
		private readonly MZZ.DAL.tb_article dal=new MZZ.DAL.tb_article();
		public tb_article()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MZZ.Model.tb_article GetModelByCache(int article_id)
		{
			
			string CacheKey = "tb_articleModel-" + article_id;
			...
			return (MZZ.Model.tb_article)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MZZ.Model.tb_article> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MZZ.Model.tb_article> DataTableToList(DataTable dt)
		{
			List<MZZ.Model.tb_article> modelList = new List<MZZ.Model.tb_article>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MZZ.Model.tb_article model;
