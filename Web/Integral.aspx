...
<head runat="server">
    ...
    <link href="styles/css/integral.css" rel="stylesheet">
</head>
<body>
    <form id="form1" runat="server">
        <div class="wrap">
            ...
            <div class="notice">
                ...
                <h3>积分兑换规则（必读）：</h3>
                <p>
                    每人每期只能兑换一件礼品，积分可累积，礼品池定期更新，喜欢的赶紧下手yo~<br />
                    请仔细填写收货地址，一旦确认无法修改喵~<br />
                </p>
            </div>
            <div class="integral">
                <p>您当前的积分为：<span id="Hidintegral" runat="server"></span></p>
                <p>积分不够？每天<a href="javascript:checkin();">签到</a>或者戳右上角<span>转发本页</span>到朋友圈，可以获得积分哦！</p>
            </div>
            ...
            <div class="weui_dialog_alert" style="display: none;">
                ...
                <div class="weui_dialog">
                    ...
                    <div class="weui_dialog_bd">~≧︿≦~奖品已经换完啦，下一期早点下手吧！</div>
        ...
        <script src="scripts/js/libs/jquery.js"></script>
        <script>
            wx.config({
                debug: false,
                appId: '<%=appId %>',
            ...
            $(function () {
                $(".get-gift").each(function () {
                    ...
                    if (num <= 1) {
                        ...
                        $(this).children("i")[1].innerText = "剩余 " + num;
                    }
